...
namespace SGE.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeAluno,Cpf,Email,Telefone,Nascimento")] Alunos alunos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeAluno,Cpf,Email,Telefone,Nascimento")] Alunos alunos)
        {
            if (id != alunos.Id)
            {
                return NotFound();
